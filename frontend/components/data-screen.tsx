      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 28 }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div style={{ display: 'flex', gap: 4, marginBottom: 18, background: T.paper, padding: 4, borderRadius: 10, width: 'fit-content', border: `1px solid ${T.line}` }}>
            {[['overview', 'Overview'], ['profit-loss', 'Profit / Loss'], ['purchase-sale', 'Purchase & Sale'], ['tax', 'Tax Report'], ['commission', 'Sales Representative'], ['register', 'Cash Register']].map(([cid, lbl]) => (
