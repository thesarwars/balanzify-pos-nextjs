...
const API: any = {
  ...
  report: {
    ...
    async contacts(params: any = {}) {
      if (REAL_MODE) return await realReq('GET', '/reports/contacts', { query: params });
      return null;
    },
    async customerGroups(params: any = {}) {
      if (REAL_MODE) return await realReq('GET', '/reports/customer-groups', { query: params });
      return null;
    },
    async stock(params: any = {}) {
      if (REAL_MODE) return await realReq('GET', '/reports/stock', { query: params });
      return null;
    },
    async stockHistory(params: any = {}) {
    ...
    async productPurchase(params: any = {}) {
      if (REAL_MODE) return await realReq('GET', '/reports/product-purchase', { query: params });
      return null;
    },
    async productSell(params: any = {}) {
    ...
    async salesRepReport(params: any = {}) {
      if (REAL_MODE) return await realReq('GET', '/reports/sales-rep', { query: params });
      return null;
    },
    async activityLog(params: any = {}) {
      if (REAL_MODE) return await realReq('GET', '/reports/activity-log', { query: params });
      return null;
    },
