...
const MESSAGES = {
  ...
  'rx.add_custom':  { en: 'Add a custom interaction', so: 'Ku dar isdhexgal gaar ah', ar: 'أضف تفاعلًا مخصصًا' },
  'rx.add_custom_hint': { en: 'Custom interactions apply only to your business.', so: 'Isdhexgallada gaarka ah waxay khuseeyaan ganacsigaaga oo keliya.', ar: 'تنطبق التفاعلات المخصصة على نشاطك التجاري فقط.' },
  'rx.drug_a':      { en: 'First drug', so: 'Daawada koowaad', ar: 'الدواء الأول' },
  'rx.drug_b':      { en: 'Second drug', so: 'Daawada labaad', ar: 'الدواء الثاني' },
  'rx.severity':    { en: 'Severity', so: 'Darnaanta', ar: 'الشدة' },
  'rx.description': { en: 'Clinical note', so: 'Qoraal caafimaad', ar: 'ملاحظة سريرية' },
  'rx.save_interaction': { en: 'Save interaction', so: 'Kaydi isdhexgalka', ar: 'حفظ التفاعل' },
  'rx.custom':      { en: 'Custom', so: 'Gaar ah', ar: 'مخصص' },
  'rx.remove':      { en: 'Remove', so: 'Saar', ar: 'إزالة' },
  'rx.err_pair':    { en: 'Enter two different drug names.', so: 'Geli laba magac oo daawo oo kala duwan.', ar: 'أدخل اسمي دوائين مختلفين.' },
  'rx.err_desc':    { en: 'Add a short clinical note.', so: 'Ku dar qoraal gaaban.', ar: 'أضف ملاحظة سريرية قصيرة.' },
  'rx.added':       { en: 'Custom interaction added.', so: 'Isdhexgal gaar ah ayaa lagu daray.', ar: 'تمت إضافة التفاعل المخصص.' },
  'rx.removed':     { en: 'Custom interaction removed.', so: 'Isdhexgalkii waa la saaray.', ar: 'تمت إزالة التفاعل.' },
